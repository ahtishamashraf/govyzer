  ...
  rows: z
    .array(
      z.object({
        ...
        built_up_area: z.coerce.number().optional(),
        balcony_area: z.coerce.number().optional(),
        plot_area: z.coerce.number().optional(),
        size_unit: z.enum(['sqft', 'sqm']).optional(),
        parking_spaces: z.coerce.number().int().optional(),
        view: z.string().max(120).optional(),
        // Numeric bounds are checked per row by the importer so bad rows surface as
        // reviewable error rows instead of rejecting the whole file.
        base_price: z.coerce.number().optional(),
        current_price: z.coerce.number().optional(),
        stock_status: z.string().max(24).optional(),
